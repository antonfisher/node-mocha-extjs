...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _chain = __webpack_require__(333);

	var _mochaUI = __webpack_require__(340);

	var _driver = __webpack_require__(342);

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var MochaExtJs = exports.MochaExtJs = function () {
	  function MochaExtJs() {
	    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { driver: new _driver.ExtJsDriver({ mochaUi: new _mochaUI.MochaUI() }) },
	        driver = _ref.driver;

	    _classCallCheck(this, MochaExtJs);

	    return function () {
	      return new _chain.Chain({ driver: driver });
	    };
	  }

	  _createClass(MochaExtJs, null, [{
	    key: 'screenshot',
	    value: function screenshot() {
	      var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '/tmp/';

	      if (window.callPhantom) {
	        var filename = path + new Date().getTime();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _set = __webpack_require__(334);

	var _actionItem = __webpack_require__(335);

	var _componentItem = __webpack_require__(338);

	var _componentActionItem = __webpack_require__(339);
	...
	var Chain = exports.Chain = function () {
	  function Chain(_ref) {
	    var driver = _ref.driver,
	        _ref$itemsRunDelay = _ref.itemsRunDelay,
	        itemsRunDelay = _ref$itemsRunDelay === undefined ? 50 : _ref$itemsRunDelay;
	    ...
	    try {
	      for (var _iterator3 = driver.supportedActions[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	        ...
	        this[_action] = this.createActionFunction(_action);
	      }
	    } catch (err) {
...
/***/ (function(module, exports) {
	...
	var Set = exports.Set = function () {
	  ...
	  _createClass(Set, [{
	    ...
	    key: 'items',
	    value: /*#__PURE__*/regeneratorRuntime.mark(function items() {
	    ...
	    key: 'reversedItems',
	    value: /*#__PURE__*/regeneratorRuntime.mark(function reversedItems() {
	      var i;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChainActionItem = exports.ChainActionItem = function (_ChainItem) {
	  ...
	  function ChainActionItem() {
	    ...
	    return _possibleConstructorReturn(this, (ChainActionItem.__proto__ || Object.getPrototypeOf(ChainActionItem)).apply(this, arguments));
	  }
	...
	var ChainItem = exports.ChainItem = function () {
	  function ChainItem(_ref) {
	    var chain = _ref.chain,
	        ...
	        _ref$callArgs = _ref.callArgs,
	        callArgs = _ref$callArgs === undefined ? [] : _ref$callArgs;
...
/***/ (function(module, exports) {
	...
	function waitForFn(waitFn, callback) {
	  var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { delay: 10, timeout: 10 * 1000, ticInterval: 500 },
	      delay = _ref.delay,
	      timeout = _ref.timeout,
	      ticInterval = _ref.ticInterval;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChainComponentItem = exports.ChainComponentItem = function (_ChainItem) {
	  ...
	  function ChainComponentItem() {
	    ...
	    var _this = _possibleConstructorReturn(this, (_ref = ChainComponentItem.__proto__ || Object.getPrototypeOf(ChainComponentItem)).call.apply(_ref, [this].concat(args)));
	  ...
	  _createClass(ChainComponentItem, [{
	    ...
	    value: function run(callback) {
	      ...
	      return (0, _utils.waitForFn)(function (done) {
	        ...
	        }, { type: type, callArgs: callArgs, chain: chain });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChainComponentActionItem = exports.ChainComponentActionItem = function (_ChainItem) {
	  ...
	  function ChainComponentActionItem() {
	    ...
	    return _possibleConstructorReturn(this, (ChainComponentActionItem.__proto__ || Object.getPrototypeOf(ChainComponentActionItem)).apply(this, arguments));
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dataview = __webpack_require__(347);

	var _radio = __webpack_require__(348);

	var _button = __webpack_require__(349);

	var _window = __webpack_require__(350);

	var _checkBox = __webpack_require__(351);

	var _comboBox = __webpack_require__(352);

	var _textField = __webpack_require__(353);

	var _cellEditor = __webpack_require__(354);

	var _numberField = __webpack_require__(355);
	  ...
	  _createClass(ExtJsDriver, [{
	    ...
	    value: function getComponent(callback, _ref2) {
	      ...
	      if (type === 'tab') {
	        ...
	        componentObject = new _dataview.ExtJsComponentDataView(properties);
	      }
	      ...
	      return componentObject.getComponent(callback, { callArgs: callArgs });
	    }
	  }, {
	    key: 'isVisibleElement',
	    value: function isVisibleElement(element) {
	      var style = window.getComputedStyle(element);
	      return Boolean(style) && (typeof style.opacity === 'undefined' || style.opacity !== 0) && (typeof style.display === 'undefined' || style.display !== 'none') && (typeof style.visibility === 'undefined' || style.visibility !== 'hidden');
	    }
	  }, {
	    key: 'waitLoadMask',
	    ...
	    get: function get() {
	      return ['tab', 'grid', 'radio', 'button', 'window', 'checkBox', 'comboBox', 'textField', 'numberField', 'cellEditor', 'dataview'];
	    }
	  }, {
	    key: 'supportedComponentActions',
	    get: function get() {
	      return ['click', 'fill', 'select', 'isEnabled', 'isDisabled', 'isHidden', 'isVisible', 'checkRowsCount', 'edit', 'clickAction'];
	    }
	  }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ExtJsComponentTab = exports.ExtJsComponentTab = function (_ExtJsComponentBase) {
	  _inherits(ExtJsComponentTab, _ExtJsComponentBase);

	  function ExtJsComponentTab() {
	    _classCallCheck(this, ExtJsComponentTab);

	    return _possibleConstructorReturn(this, (ExtJsComponentTab.__proto__ || Object.getPrototypeOf(ExtJsComponentTab)).apply(this, arguments));
	  }

	  _createClass(ExtJsComponentTab, [{
	    key: 'generateSelectors',
	    value: function generateSelectors(titleOrSelector) {
	      return [this.componentType + '[title~="' + titleOrSelector + '"]'].concat(_toConsumableArray(_get(ExtJsComponentTab.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentTab.prototype), 'generateSelectors', this).call(this, titleOrSelector)));
	    }
	  }, {
	    key: 'titleProperties',
	    get: function get() {
	      return ['title'].concat(_toConsumableArray(_get(ExtJsComponentTab.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentTab.prototype), 'titleProperties', this)));
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _base2 = __webpack_require__(344);
	...
	var ExtJsComponentGrid = exports.ExtJsComponentGrid = function (_ExtJsComponentBase) {
	  ...
	  function ExtJsComponentGrid() {
	    ...
	    return _possibleConstructorReturn(this, (ExtJsComponentGrid.__proto__ || Object.getPrototypeOf(ExtJsComponentGrid)).apply(this, arguments));
	  }

	  _createClass(ExtJsComponentGrid, [{
	    key: 'generateSelectors',
	    value: function generateSelectors(titleOrSelector) {
	      return [this.componentType + '[text~="' + titleOrSelector + '"]'].concat(_toConsumableArray(_get(ExtJsComponentGrid.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentGrid.prototype), 'generateSelectors', this).call(this, titleOrSelector)));
	    }
	  }, {
	    key: 'select',
	    ...
	    key: 'clickAction',
	    value: function clickAction(callback) {
	      var rowIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

	      var _this3 = this;

	      var colIndex = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
	      var actionIndex = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;

	      var cmp = this.extJsComponent;
	      var htmlElement = null;

	      try {
	        htmlElement = document.getElementById(cmp.el.id).getElementsByClassName('x-grid-item')[rowIndex].getElementsByClassName('x-grid-cell')[colIndex].getElementsByClassName('x-action-col-icon')[actionIndex];
	      } catch (e) {
	        return callback('Failed to get element of "' + this.componentType + '" row #' + rowIndex + '": ' + e);
	      }

	      new _base.HTMLComponentBase({ htmlElement: htmlElement, driver: this.driver }).click(function (err) {
	        return callback(err ? 'Failed to click on action item in row #' + rowIndex + ' of "' + _this3.componentType + '" ": ' + err : null);
	      });
	    }
	  }, {
	    key: 'titleProperties',
	    get: function get() {
	      return ['title'].concat(_toConsumableArray(_get(ExtJsComponentGrid.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentGrid.prototype), 'titleProperties', this)));
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.ExtJsComponentDataView = undefined;
	...
	var ExtJsComponentDataView = exports.ExtJsComponentDataView = function (_ExtJsComponentBase) {
	  _inherits(ExtJsComponentDataView, _ExtJsComponentBase);

	  function ExtJsComponentDataView() {
	    _classCallCheck(this, ExtJsComponentDataView);

	    return _possibleConstructorReturn(this, (ExtJsComponentDataView.__proto__ || Object.getPrototypeOf(ExtJsComponentDataView)).apply(this, arguments));
	  }
	  ...
	  _createClass(ExtJsComponentDataView, [{
	    ...
	    value: function select(callback, index) {
	      ...
	      new _base.HTMLComponentBase({ htmlElement: htmlElement, driver: this.driver }).click(function (err) {
	        return callback(err ? 'Failed to click on item index #' + index + ' of "' + _this2.componentType + '" ": ' + err : null);
	      });
	    }
	  }]);

	  return ExtJsComponentDataView;
	}(_base2.ExtJsComponentBase);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ExtJsComponentRadio = exports.ExtJsComponentRadio = function (_ExtJsComponentBase) {
	  ...
	  function ExtJsComponentRadio() {
	    ...
	    return _possibleConstructorReturn(this, (ExtJsComponentRadio.__proto__ || Object.getPrototypeOf(ExtJsComponentRadio)).apply(this, arguments));
	  }

	  _createClass(ExtJsComponentRadio, [{
	    key: 'generateSelectors',
	    value: function generateSelectors(titleOrSelector) {
	      return [this.componentType + '[boxLabel~="' + titleOrSelector + '"]', this.componentType + '[fieldLabel~="' + titleOrSelector + '"]'].concat(_toConsumableArray(_get(ExtJsComponentRadio.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentRadio.prototype), 'generateSelectors', this).call(this, titleOrSelector)));
	    }
	  }, {
	    key: 'titleProperties',
	    get: function get() {
	      return ['fieldLabel', 'boxLabel'].concat(_toConsumableArray(_get(ExtJsComponentRadio.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentRadio.prototype), 'titleProperties', this)));
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ExtJsComponentButton = exports.ExtJsComponentButton = function (_ExtJsComponentBase) {
	  ...
	  function ExtJsComponentButton() {
	    ...
	    return _possibleConstructorReturn(this, (ExtJsComponentButton.__proto__ || Object.getPrototypeOf(ExtJsComponentButton)).apply(this, arguments));
	  }

	  _createClass(ExtJsComponentButton, [{
	    key: 'generateSelectors',
	    value: function generateSelectors(titleOrSelector) {
	      return [this.componentType + '[text~="' + titleOrSelector + '"]'].concat(_toConsumableArray(_get(ExtJsComponentButton.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentButton.prototype), 'generateSelectors', this).call(this, titleOrSelector)));
	    }
	  }, {
	    key: 'titleProperties',
	    get: function get() {
	      return ['text'].concat(_toConsumableArray(_get(ExtJsComponentButton.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentButton.prototype), 'titleProperties', this)));
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ExtJsComponentWindow = exports.ExtJsComponentWindow = function (_ExtJsComponentBase) {
	  ...
	  function ExtJsComponentWindow() {
	    ...
	    return _possibleConstructorReturn(this, (ExtJsComponentWindow.__proto__ || Object.getPrototypeOf(ExtJsComponentWindow)).apply(this, arguments));
	  }

	  _createClass(ExtJsComponentWindow, [{
	    key: 'generateSelectors',
	    value: function generateSelectors(titleOrSelector) {
	      return [this.componentType + '[text~="' + titleOrSelector + '"]'].concat(_toConsumableArray(_get(ExtJsComponentWindow.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentWindow.prototype), 'generateSelectors', this).call(this, titleOrSelector)));
	    }
	  }, {
	    key: 'titleProperties',
	    get: function get() {
	      return ['title'].concat(_toConsumableArray(_get(ExtJsComponentWindow.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentWindow.prototype), 'titleProperties', this)));
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ExtJsComponentCheckBox = exports.ExtJsComponentCheckBox = function (_ExtJsComponentBase) {
	  ...
	  function ExtJsComponentCheckBox() {
	    ...
	    return _possibleConstructorReturn(this, (ExtJsComponentCheckBox.__proto__ || Object.getPrototypeOf(ExtJsComponentCheckBox)).apply(this, arguments));
	  }

	  _createClass(ExtJsComponentCheckBox, [{
	    key: 'generateSelectors',
	    value: function generateSelectors(titleOrSelector) {
	      return [this.componentType + '[boxLabel~="' + titleOrSelector + '"]', this.componentType + '[fieldLabel~="' + titleOrSelector + '"]'].concat(_toConsumableArray(_get(ExtJsComponentCheckBox.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentCheckBox.prototype), 'generateSelectors', this).call(this, titleOrSelector)));
	    }
	  }, {
	    key: 'titleProperties',
	    get: function get() {
	      return ['fieldLabel', 'boxLabel'].concat(_toConsumableArray(_get(ExtJsComponentCheckBox.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentCheckBox.prototype), 'titleProperties', this)));
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ExtJsComponentComboBox = exports.ExtJsComponentComboBox = function (_ExtJsComponentBase) {
	  ...
	  function ExtJsComponentComboBox() {
	    ...
	    return _possibleConstructorReturn(this, (ExtJsComponentComboBox.__proto__ || Object.getPrototypeOf(ExtJsComponentComboBox)).apply(this, arguments));
	  }

	  _createClass(ExtJsComponentComboBox, [{
	    key: 'generateSelectors',
	    value: function generateSelectors(titleOrSelector) {
	      return [this.componentType + '[fieldLabel~="' + titleOrSelector + '"]'].concat(_toConsumableArray(_get(ExtJsComponentComboBox.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentComboBox.prototype), 'generateSelectors', this).call(this, titleOrSelector)));
	    }
	  }, {
	    key: 'select',
	    value: function select(callback, index) {
	    ...
	    key: 'titleProperties',
	    get: function get() {
	      return ['fieldLabel'].concat(_toConsumableArray(_get(ExtJsComponentComboBox.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentComboBox.prototype), 'titleProperties', this)));
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ExtJsComponentTextField = exports.ExtJsComponentTextField = function (_ExtJsComponentBase) {
	  _inherits(ExtJsComponentTextField, _ExtJsComponentBase);

	  function ExtJsComponentTextField() {
	    _classCallCheck(this, ExtJsComponentTextField);

	    return _possibleConstructorReturn(this, (ExtJsComponentTextField.__proto__ || Object.getPrototypeOf(ExtJsComponentTextField)).apply(this, arguments));
	  }

	  _createClass(ExtJsComponentTextField, [{
	    key: 'generateSelectors',
	    value: function generateSelectors(titleOrSelector) {
	      return [this.componentType + '[fieldLabel~="' + titleOrSelector + '"]'].concat(_toConsumableArray(_get(ExtJsComponentTextField.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentTextField.prototype), 'generateSelectors', this).call(this, titleOrSelector)));
	    }
	  }, {
	    key: 'titleProperties',
	    get: function get() {
	      return ['fieldLabel'].concat(_toConsumableArray(_get(ExtJsComponentTextField.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentTextField.prototype), 'titleProperties', this)));
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ExtJsComponentCellEditor = exports.ExtJsComponentCellEditor = function (_ExtJsComponentBase) {
	  ...
	  function ExtJsComponentCellEditor() {
	    ...
	    return _possibleConstructorReturn(this, (ExtJsComponentCellEditor.__proto__ || Object.getPrototypeOf(ExtJsComponentCellEditor)).apply(this, arguments));
	  }
	  ...
	  _createClass(ExtJsComponentCellEditor, [{
	    ...
	    value: function getComponent(callback, _ref) {
	      ...
	      var cmp = this.chain.lastComponent.extJsComponent;
	      var htmlElement = null;
	      ...
	      new _base.HTMLComponentBase({ htmlElement: htmlElement, driver: this.driver }).click(function (err) {
	        ...
	        try {
	          var editorElements = document.getElementById(cmp.el.id).getElementsByClassName('x-editor');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ExtJsComponentNumberField = exports.ExtJsComponentNumberField = function (_ExtJsComponentBase) {
	  _inherits(ExtJsComponentNumberField, _ExtJsComponentBase);

	  function ExtJsComponentNumberField() {
	    _classCallCheck(this, ExtJsComponentNumberField);

	    return _possibleConstructorReturn(this, (ExtJsComponentNumberField.__proto__ || Object.getPrototypeOf(ExtJsComponentNumberField)).apply(this, arguments));
	  }

	  _createClass(ExtJsComponentNumberField, [{
	    key: 'generateSelectors',
	    value: function generateSelectors(titleOrSelector) {
	      return [this.componentType + '[fieldLabel~="' + titleOrSelector + '"]'].concat(_toConsumableArray(_get(ExtJsComponentNumberField.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentNumberField.prototype), 'generateSelectors', this).call(this, titleOrSelector)));
	    }
	  }, {
	    key: 'titleProperties',
	    get: function get() {
	      return ['fieldLabel'].concat(_toConsumableArray(_get(ExtJsComponentNumberField.prototype.__proto__ || Object.getPrototypeOf(ExtJsComponentNumberField.prototype), 'titleProperties', this)));
	    }
	  }]);
